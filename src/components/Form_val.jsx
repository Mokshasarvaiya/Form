...
const Form_val = () => {
  ...
  return (
    <div>
      ...
      <input type="number" name="" id="" className='input' /><br />
     ...
     <h3>
        <div ><input type="checkbox" name="" id="" className='checkbox' />&nbsp;
      I Agree  <span> Company Terms</span> And <span> Policy</span></div></h3>
